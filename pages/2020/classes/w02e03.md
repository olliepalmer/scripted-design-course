...
document.getElementById("rdmfile").onclick = function(){
	var link = Math.floor(Math.random() * (max - min + 1) ) + min;
	document.getElementById("rdmfile").href="/assets/instructions-mp3/"+num+".mp3";
	return false;
}
