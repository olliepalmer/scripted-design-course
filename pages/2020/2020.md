...
If you are enrolled in the course at MIVC, you will be expected to upload work from the exercises in time for each class. If you're participating from elsewhere, you are free to do exercises whenever it suits you.
...
If you are not enrolled at MIVC and would also like to contribute, please [contact me](#contact).

Each the MIVC class will meet on a Zoom call, where we will discuss the weeks' activities and review each others' work. We will be using the following technologies to communicate:
